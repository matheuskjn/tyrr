#Essa classe serve para capturar a janela do jogo e retornar uma imagem vetorizada
#Tambem é responsabilidade dela identificar a posicao da janela do jogo para ajudar na posição de cliques do mouse 
